          ...
          <div className='profile-right'>
            {editing ? (
              ...
              <div className='profile-info'>
                <p>
                  <FontAwesomeIcon icon={faUser} /> <strong>Nom:</strong> {user.Nom}
                </p>
                <p>
                  <FontAwesomeIcon icon={faEnvelope} /> <strong>Email:</strong> {user.Email}
                </p>
                <p>
                  <FontAwesomeIcon icon={faPhone} /> <strong>Numéro:</strong> {user.Num}
                </p>
                <p className='bio'>
                  <FontAwesomeIcon icon={faCalendarAlt} /> <strong>BIO:</strong> {user.Bio}
                </p>
                <p className='date'>
                  <FontAwesomeIcon icon={faCalendarAlt} /> <strong>Date de Naissance:</strong> {formatDate(user.DateNaissance)}
                </p>
